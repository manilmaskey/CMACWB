...
public class JpegImagesToMovie implements ControllerListener, DataSinkListener {
	...
	System.err.println("...done processing movie.");
	 ...
	 */
 	public void read(Buffer buf) throws IOException {
	    ...
	    // uses default quality which is not very good
//	    ImageIO.write(image, "JPG", new File(".movtemp.jpg"));
	    
// increase quality over default    
...
//	      new File(".movtemp.jpg")));
//
//	    // writes the file with given compression level 
//	    // from your JPEGImageWriteParam instance
//	    writer.write(null, new IIOImage(image, null, null), jpegParams);	    
	    
	    ImageOutputStream  ios =  ImageIO.createImageOutputStream(new File(".movtemp.jpg"));
