...
public class WMSLayersPanel extends JPanel
{
    ...
    protected void load()
    {
        ...
        catch (Exception e)
        {
            ...
            JOptionPane.showMessageDialog(c, "Could not retrieve WMS server capabilities", 
            		"WMS server access error", JOptionPane.ERROR_MESSAGE);
            // remove this layer panel from its parent
    ...
    protected void makeLayerInfosPanel(Collection<LayerInfo> layerInfos)
    {
        ...
        //this.revalidate(); use validate() because revalidate() does a deferred automatic layout which doesn't work
        // when using this inside the SWT container in Glider
        this.validate();
    }
