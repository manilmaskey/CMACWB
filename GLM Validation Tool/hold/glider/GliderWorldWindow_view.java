 ...
 */
public class GliderWorldWindow_view extends WorldWindowGLCanvas implements View
{
...
//        ApplicationTemplate.insertBeforeCompass(this, layer);
        ApplicationTemplate.insertBeforeLayerName(this, layer, "Political Boundaries");
    ...
    protected class LayerListener implements PropertyChangeListener
    {
        ...
        {
            GliderWorldWindow_view.this.firePropertyChange(GliderImage.GLIDER_IMAGE_SOURCE, null, this);
            GliderWorldWindow_view.this.repaint();
        }
    }
...
//    }
    // TAB Modified to save additional state properties
    @Override
    public void copyViewState(View view)
    {
        this.globe = view.getGlobe();
        ...
        this.setFarClipDistance(view.getFarClipDistance());
        this.setNearClipDistance(view.getNearClipDistance());
//        this.setDetectCollisions(view.isDetectCollisions());
        this.setFieldOfView(view.getFieldOfView());
        this.setEyePosition(view.getEyePosition());
        this.setHeading(view.getHeading());
        this.setPitch(view.getPitch());
        System.out.println("copyViewState Modified TAB");
